...
$.fn.skate.defaults = {
	...
	'delay': 10,					// How long to show a single slide.
...
$.fn.skate.defaults.autoplay = true;
...
$('.no-animation > h1').html($('.no-animation > h2').html() + ' (Keyboard Controls Disabled)');
$('.crossfade-animation > h2').html($('.crossfade-animation > h2').html() + ' (Keyboard Attached Here By Default)');
